...
## Intro
Cap was a new release when I first started doing Hack the Box, and I don't think it was very well recieved at first because of how easy it was (although TryHackMe probably would have taken this one with open arms). I'll start by looking at (what seems to be?) an admin panel, and download some .pcap files. I'll get some creds from there, and SSH into the box. We then find linux capabilities to spawn a root shell.
...
![asdf](https://an00brektn.github.io/img/Pasted image 20210908122958.png)

We get a different pcap file from this web page, and this one has some more useful content in it.

![asdf](https://an00brektn.github.io/img/Pasted image 20210908123512.jpg)
