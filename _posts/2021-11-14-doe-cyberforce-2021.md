...
Then we have to go in and find what they're asking of us. Suppose we find the file in Downloads. We run `netstat -an` to find the program, and we give our response. They ask follow-ups, we supply answers. We then gets points for our ability to respond.
