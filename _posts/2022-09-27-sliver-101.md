...
- sliver
- golang
description: "Command and control your friends (or your enemeies) >:)"
categories:
published: true
comments: false
---

![intro](https://raw.githubusercontent.com/BishopFox/sliver/master/.github/images/sliver.jpeg?token=AAGVUDRDHPMSBO5JFR3Q7RC5BL2YA)
...
![slifer](https://static.wikia.nocookie.net/yu-gi-ohfanon/images/5/5f/Slifer_the_Sky_Dragon.jpg/revision/latest/scale-to-width-down/320?cb=20100717163613)
...
### Staging
Sliver is written in Golang, a programming language that compiles statically by default. This is different from your typical C executable, which is usually linked to external libraries to import commands from. As such, you'll notice that Sliver's generated implants are very large by default.
...
![alarmobot](https://static.wikia.nocookie.net/hearthstone_gamepedia/images/d/d3/EX1_006.png/revision/latest/scale-to-width-down/330?cb=20220710113735)
